...
PYBIND11_MODULE(_ocd_vehicle_models_py, m)
{
  BIND_OCD_VEHICLE_MODEL(
    ...
    tam::ocd::vehicle_dynamics::VehicleDynamicsDoubleTrackModel, tam::ocd::tire_models::MF52,
  ...
  BIND_OCD_VEHICLE_MODEL(
    ...
    tam::ocd::drivetrain::DrivetrainWheelTorqueModel,
    tam::ocd::steering_actuator::PT1SteeringActuatorModel,
    tam::ocd::vehicle_dynamics::VehicleDynamicsDoubleTrackModel, tam::ocd::tire_models::Linear,
    tam::ocd::aerodynamics::DefaultAerodynamicsModel);
  ...
  BIND_OCD_VEHICLE_MODEL(
    ...
    tam::ocd::drivetrain::DrivetrainWheelTorqueModel,
    tam::ocd::steering_actuator::PT1SteeringActuatorModel,
    tam::ocd::vehicle_dynamics::VehicleDynamicsDoubleTrackModel, tam::ocd::tire_models::MF_Simple,
    tam::ocd::aerodynamics::DefaultAerodynamicsModel);
  ...
  BIND_OCD_VEHICLE_MODEL(
    ...
    tam::ocd::tire_models::MF_Simple_Extended, tam::ocd::aerodynamics::DefaultAerodynamicsModel);
  ...
  BIND_OCD_VEHICLE_MODEL(
    ...
    tam::ocd::steering_actuator::PT1SteeringActuatorModel,
    tam::ocd::vehicle_dynamics::VehicleDynamicsDoubleTrackModel,
    tam::ocd::tire_models::MF_Simple_Extended, tam::ocd::aerodynamics::RideHeightAerodynamicsModel);
  ...
  BIND_OCD_VEHICLE_MODEL(
    ...
    tam::ocd::drivetrain::DrivetrainFxModel, tam::ocd::steering_actuator::PT1SteeringActuatorModel,
    tam::ocd::vehicle_dynamics::VehicleDynamicsDoubleTrackModel, tam::ocd::tire_models::MF52,
    tam::ocd::aerodynamics::DefaultAerodynamicsModel);
