...
These templated structs provide helper functionality to conditionally add
   ...
   This is required since an feedback is optional for both drivetrain and steering actuator models.
...
struct FeedbackHelperCH
{
  virtual void publish_feedback(T feedback, rclcpp::Time timestamp) = 0;
};
}  // namespace auxiliary::conditional_compilation
