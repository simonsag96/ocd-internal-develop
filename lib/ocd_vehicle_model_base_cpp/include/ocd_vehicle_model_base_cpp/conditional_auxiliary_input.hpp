...
These templated structs provide helper functionality to conditionally add
   ...
   This is required since an auxiliary input is optional for both drivetrain and steering actuator models.
...
template <typename T>
struct AuxiliaryInputHelperSA_VEH;

// 2. Define the template overload for the void case
template <>
struct AuxiliaryInputHelperSA_VEH<void>
{
  // empty — no function
};
...
struct AuxiliaryInputHelperSA_VEH
{
  virtual void set_auxiliary_input_steering_actuator(const T & value) = 0;
};

/// ==========================
/// Repeat for the drivetrain
/// ==========================
...
// 1. Declare the struct
template <typename T>
struct AuxiliaryInputHelperDT_VEH;

// 2. Define the template overload for the void case
template <>
struct AuxiliaryInputHelperDT_VEH<void>
{
  // empty — no function
};
...
struct AuxiliaryInputHelperDT_VEH
{
  virtual void set_auxiliary_input_drivetrain(const T & value) = 0;
};
}  // namespace auxiliary::conditional_compilation
