...
template <
  tam::ocd::interfaces::concepts::TireModel TireModelT,
  tam::ocd::interfaces::concepts::AerodynamicsModel AeroModelT>
void VehicleDynamicsSingleTrackEqns<TireModelT, AeroModelT>::calculate_tire_spring_force_N()
{  // Tire spring forces
...
template <
  tam::ocd::interfaces::concepts::TireModel TireModelT,
  tam::ocd::interfaces::concepts::AerodynamicsModel AeroModelT>
void VehicleDynamicsSingleTrackEqns<TireModelT, AeroModelT>::calculate_suspension_spring_force_N()
{
...
template <
  tam::ocd::interfaces::concepts::TireModel TireModelT,
  tam::ocd::interfaces::concepts::AerodynamicsModel AeroModelT>
void VehicleDynamicsSingleTrackEqns<TireModelT, AeroModelT>::calculate_suspension_damper_force_N()
{
...
template <
  tam::ocd::interfaces::concepts::TireModel TireModelT,
  tam::ocd::interfaces::concepts::AerodynamicsModel AeroModelT>
void VehicleDynamicsSingleTrackEqns<TireModelT, AeroModelT>::calculate_antiroll_bar_force_N()
{
...
template <
  tam::ocd::interfaces::concepts::TireModel TireModelT,
  tam::ocd::interfaces::concepts::AerodynamicsModel AeroModelT>
void VehicleDynamicsSingleTrackEqns<TireModelT, AeroModelT>::calculate_axle_vertical_force_N()
{  // Total Axle Forces
  // See page A-30
